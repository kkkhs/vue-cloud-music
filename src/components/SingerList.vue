...
<template>
  <div class="tw-flex tw-flex-col tw-pb-24">
    <div 
    ...
    >
      ...
      <div class=" tw-w-full tw-flex tw-flex-1 tw-justify-between tw-items-center tw-border-solid tw-border-t-0 tw-border-l-0 tw-border-r-0 tw-border-b-[1px] tw-border-slate-200 tw-pb-1">
        <div>
          <span class="tw-flex tw-flex-col tw-text-base tw-font-medium tw-mb-1 tw-line-clamp-1">{{ singer.name }}</span>
          <span 
        ...
        <div>
          <div class="tw-transition-all tw-ease-in-out tw-text-xs tw-border-solid tw-rounded-3xl tw-border-[1px] tw-mr-8 tw-py-1 tw-px-2 tw-text-red-500 hover:tw-text-white hover:tw-bg-red-500"> + 关注</div>
        </div>
      </div>
    </div>
  </div>
